...
export default function SearchPage() {
    ...
    const videosQuery = useMemoFirebase(() => {
        ...
        // This is a simplified search. For production, use a dedicated search service like Algolia or MeiliSearch.
        // Firestore's querying capabilities for text search are limited.
        // We will search on title and description. `array-contains` is not suitable for substring searches.
        // A common workaround is to store keywords in an array. Here we'll just check for a direct match which is not ideal.
